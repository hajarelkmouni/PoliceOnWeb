    ...
    <div class="container" id="tablePersoDisparue">
        <div class="table-wrapper">
             <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2 style="margin-top:25px">Gestion des <b>Personnes disparues</b></h2>
					</div>
					<div class="col-sm-6">					
						<a href="crudPd" class="btn" style="background-color:cadetblue;"><i class="fas fa-list"></i><span>Liste principale</span></a>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
					<form action="findPd" method="POST" style="display:flex;margin-top:8px;margin-left:277px;">
			    ...
			    <c:set var="bs" value="${ImageToBase64.convertToBase64(pathToPhoto)}"/>                 
                    <tr>
		                <td class="persoImg"><c:if test="${not empty bs}"><img src='data:image/jpeg;base64,${bs}'></c:if></td>						
                       	<td>${personne.getCIN_pd() }</td>
		                <td>${personne.getAge() }</td>
		                <td>${personne.getNom() }</td>
		                <td>${personne.getPrenom() }</td>
		                <td>${personne.getDatedisparition() }</td>
		                <td>${personne.getLieudisparition() }</td>
		                <td>${personne.getDescription() }</td>
                        <td>
                            <a href="editPersonneDisparue?CIN_pd=${personne.getCIN_pd() }" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Modifier">&#xE254;</i></a>
                        	<a href="deletePersonneDisparue?CIN_pd=${personne.getCIN_pd() }" onclick="return confirm('Cette action est irréversible , êtes-vous sûr de bien vouloir supprimer?');" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Supprimer">&#xE872;</i></a>	
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" action="addPersonneDisparue">
					...
					<div class="modal-body">					
						<div class="form-group">
							<label>CIN</label>
							<input type="text" class="form-control" name="CIN_pd"  required>
						</div>
						<div class="form-group">
							<label>Age</label>
						...
						<div class="form-group">
							...
							<input type="datetime-local" name="datedisparition"class="form-control" required>
						</div>	
						<div class="form-group">
							<label>Lieu de disparition</label>
							<input type="text" name="lieudisparition" class="form-control" required>
						</div>	
						<div class="form-group">
