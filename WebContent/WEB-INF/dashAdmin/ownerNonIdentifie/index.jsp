...
@media screen and (max-width: 768px) {
  ...
  .swiper-navBtn{
    ...
    <div class="ajout" id="ajout">
      				<a href="crudObj" class="btn" style="color:white;font-weight:bold;background-color:cadetblue;margin-right:550px"><i class="fas fa-home"></i> <span>Liste principale</span></a>                                      
					<form action="findObj" method="POST" style="display:flex;">
        ...
        <div class="slide-container swiper" id="slider">
            <div class="slide-content">
				...
				<c:forEach items="${listobj}" var="perso" varStatus="status">
			    ...
			    <c:set var="bs" value="${ImageToBase64.convertToBase64(pathToPhoto)}"/>				         
                    <div class="carde swiper-slide">
                        ...
                        <div class="card-content">
                            <h2 class="name">Id:${perso.getId_obj() } ${perso.getDate()}-${perso.getLieu()}</h2>
                            <p class="description">Description:${perso.getDescription() }</p>

							<a class="button" href="deleteObjetDisparu?id_obj=${perso.getId_obj() }" onclick="return confirm('Cette action est irréversible , êtes-vous sûr de bien vouloir supprimer?');"  role="button">Supprimer</a>
                        </div>
                    </div>                
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" action="addObjetDisparu">
