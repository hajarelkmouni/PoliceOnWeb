...
.multi_step_form #msform .previous_button:hover, .multi_step_form #msform .previous_button:focus {
 ...
 <main>
  ...
  <form action="addTemoignage" method="POST" id="msform"> 
    <!-- Tittle -->
    <div class="tittle">
    ...
    <ul id="progressbar">
      ...
      <li>Informations du témoignage</li>
    </ul>
    <!-- fieldsets -->
    <fieldset>
      ...
      <div class="form-row"> 
        <div class="form-group col-md-6"> 
          ...
          <input type="text"  name="CINUser" class="form-control" placeholder="Entrer votre CIN" style="margin-left:52%;"> 
        </div>  
    ...
    <fieldset>
      <h3 style="margin-top:-40px">Informations du témoignage</h3>
     <div class="form-row">
     <div class="form-group col-md-6">  
          <label for="gender" >Identifiant de la personne:*</label>                      
          <input type="text" id="id_concerne" class="form-control" value="${testId }" name="id_concerne" readonly> 
        </div>      
     <div class="form-group col-md-6"  style="margin-top:32px">  
        <select class="product_select" name="typet">
          <option data-display="Choisir le type de témoignage">Personne disparue</option> 
          <option>Personne recherchée</option>
          <option>Personne non identifiée</option>
          <option>Propriétaire Recherché</option>           
        </select>
     </div>   
     <div class="form-group col-md-6" > 
          <label for="gender" >Description:*</label>                              
          <textarea  rows="5" cols="70" class="form-control" name="description" placeholder="Description détaillée des faits : déroulement chronologique, motif de votre contact avec la police, comportements, circonstances des faits, …"></textarea>
      </div>          
     </div>                     
