...
<div class='box'>
  <div class='box-form'>
    ...
    <div class='box-login-title'>
      </div><h2>Témoignage</h2>
    <div class='box-login'>
      <div class='fieldset-body' id='login_form'>
                    <p class='field'>
          <label for='user'>Identifiant de la personne:</label>
          <input type='text' id='user' name='id_concerne' value="${testId }" readonly>
          <span id='valida' class='i i-warning'></span>
        </p>	
        	<p class='field'>
          <label for='user'>Description</label>
          <input type='text' id='user' name='description' title='Username' />
          <span id='valida' class='i i-warning'></span>
        </p>
        
      	  <p class='field'>
          
       <label for="pass">Témoignage pour une:</label>
          <select name="typet" id="pass" style="width:280px;height:30px;">
			  <option value="Personne disparue">Personne disparue</option>
			  <option value="Personne recherchée">Personne recherchée</option>
			  <option value="Personne non identifiée">Personne non identifiée</option>
			  <option value="Propiriétaire recherché">Propiriétaire recherché</option>
			</select>
          ...
          <br><br>
        	...
        	<input type='submit' id='do_login' value='Enoyer' title='Get Started' />
      </div>
    </div>
  </div>
  </div>
