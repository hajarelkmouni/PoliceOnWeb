...
.multi_step_form #msform .previous_button:hover, .multi_step_form #msform .previous_button:focus {
 ...
 <main>
  ...
  <form action="addPlaintePersoDisparue" method="POST" id="msform"> 
    <!-- Tittle -->
    <div class="tittle">
    ...
    <ul id="progressbar">
      ...
      <li>Informations de la personne disparue</li>
    </ul>
    <!-- fieldsets -->
    <fieldset>
    ...
    <fieldset>
      <h3 style="margin-top:-40px">Informations de la personee disparue</h3>
     <div class="form-row">
     <div class="form-group col-md-6">  
          <input type="text" id="cin" class="form-control" placeholder="CIN de la personne" name="CIN_pd" > 
        </div> 
        <div class="form-group col-md-6" > 
          <input type="text" id="filliationconnue" class="form-control" placeholder="Age" name="age" > 
        </div>          
     <div class="form-group col-md-6">  
          <input type="text" id="cin" class="form-control" placeholder="Nom" name="nom" > 
        </div> 
     <div class="form-group col-md-6">  
          <input type="text" id="cin" class="form-control" placeholder="Prénom" name="prenom" > 
        </div>  
        <div class="form-group col-md-6">
          <input type="datetime-local"  class="form-control" placeholder="Date de disparition" name="datedisparition" > 
        </div>
     <div class="form-group col-md-6">  
          <input type="text" id="cin" class="form-control" placeholder="Lieu de disparition" name="lieudisparition" > 
        </div>                           
