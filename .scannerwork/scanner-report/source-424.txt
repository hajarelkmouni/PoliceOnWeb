...
<div class="aa" style="margin-top:50px;width:auto;">
     ...
     <a href="allPniVisiteur" style="height:35px;width:10%;font-size:15px;margin-left:940px;margin-bottom:-142px"class="btn btn-warning"><i class="fas fa-home"> Accueil</i></a> 
	 <form action="findPniVisiteur" method="POST" >
...
<c:forEach items = "${listpni}" var="personne" varStatus="boucle">
	...
	<div class="gallery">
	  ...
	  <a href="temoignage?id=${personne.getId_pni() }">Faire un  témoignage <i class="fas fa-angle-right"></i></a>
	</div>
	</c:forEach>
</div>
</body>
